  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
        <fieldset class="layui-elem-field">
            <legend>类型管理 - 类型更改</legend>
            <div class="layui-field-box">
                <hr>
                <form class="layui-form" action="${pageContext.request.contextPath}/type/updateType" method="post">
                    <div class="layui-form-item">
                        <label class="layui-form-label">类型名称</label>
                        <div class="layui-input-block">
                        <input type="hidden" name="tid"value="${type.tid}">
                        <input type="text" name="tname" required  lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input" value="${type.tname}">
                        </div>
                    </div>                    
                    <div class="layui-form-item">
                        <div class="layui-input-block">
