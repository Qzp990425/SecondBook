...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <!-- Start Topbar -->
        <div class="topbar">
            <h1  style="display:inline-block;">注册</h1><a href="${pageContext.request.contextPath}/user/login.jsp">去登录</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/user/forget.jsp">找回密码</a>
        </div>
        <!-- End Topbar -->
        ...
        <div class="sidebars"style="padding-left: 300px;">
            ...
            <div class="sidebar one-half-seg">
                ...
                <div class="feedback-form">
                    ...
                    <!-- Start Form -->
                    <form id="feedback_form" method="post" action="${pageContext.request.contextPath}/user/register">
                        ...
                        <fieldset>
                            ...
                            <div class="captcha-image" style="position: absolute;left: 500px;top: 350px;">
                            	<img id="security_code" onclick="changeCode()" src="getVerifyCode">
                            	
                            </div>
							<label> </label>
                            <div class="feedback-button" style="display:inline-block;">
                                <input type="submit" class="blue-button" id="send_message" value="注册">
                            </div>
                        </fieldset>
