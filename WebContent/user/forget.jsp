...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <!-- Start Topbar -->
        <div class="topbar">
            <h1 style="display:inline-block;">找回密码</h1><a href="${pageContext.request.contextPath}/user/login.jsp">去登录</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/user/register.jsp">去注册</a>
        </div>
        <!-- End Topbar -->
        ...
        <div class="sidebars"style="padding-left: 300px;">
            ...
            <div class="sidebar one-half-seg">
                ...
                <div class="feedback-form">
                    ...
                    <!-- Start Form -->
                    <form id="feedback_form" method="post" action="${pageContext.request.contextPath}/user/forget">

                        <fieldset>
                            <label>输入您的学号/登录账号</label>
                            <input type="text" name="sno" id="sno" value="" />

                            <label>输入您注册时候的手机号码</label>
                            <input type="text" name="tel"  value="" />
							
							<label>输入你更改后的密码</label>
                            ...
                            <div class="feedback-button" style="display:inline-block;">
                                <input type="submit" class="blue-button" id="send_message" value="更改">
                            </div>
                        </fieldset>
