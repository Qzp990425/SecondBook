...
public interface OrderService {
	...
	public void insertOrder(User user,Integer[] pid,Integer[] number,String name,Integer[] soldId);
	...
	void insertOrderOne(User user, Integer bid, Integer number,String name,Integer soldId);
}
